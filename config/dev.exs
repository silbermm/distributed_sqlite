...
config :distributed_sqlite, DistributedSqliteWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "e5FEjAEi3GBnA3GWExdvNJXNURJq79vpVFyyhD8OMMtrEdoQssS+HFxlwgYLO/6Q",
  watchers: [
...
config :distributed_sqlite, DistributedSqliteWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/distributed_sqlite_web/(live|views)/.*(ex)$",
      ~r"lib/distributed_sqlite_web/templates/.*(eex)$"
    ]
  ]
